<div class="p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <!-- Hotel Overview Card -->
        <div class="bg-white dark:bg-gray-700 rounded-lg shadow-md p-6 flex flex-col h-full">
        ...
        <!-- Add Content Card -->
        <div class="bg-white dark:bg-gray-700 rounded-lg shadow-md p-6 flex flex-col items-center text-center h-full">
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4 flex-1">Enrich your Facilities and Services in just a couple clicks</p>
            <button class="px-6 py-2 bg-orange-500 text-white rounded-lg hover:bg-orange-600 transition-colors mt-auto">
                ADD CONTENT
            </button>
        </div>
        ...
        <div class="bg-white dark:bg-gray-700 rounded-lg shadow-md p-6 flex flex-col items-center text-center h-full">
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4 flex-1">Use your Colours, Logo, Images and Icons</p>
            <button class="px-6 py-2 bg-orange-500 text-white rounded-lg hover:bg-orange-600 transition-colors mt-auto">
                EDIT STYLE
            </button>
        </div>
        ...
        <div class="bg-white dark:bg-gray-700 rounded-lg shadow-md p-6 flex flex-col items-center text-center h-full">
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4 flex-1">Manage all Requests and Reservations from ACTIVITY</p>
            <button class="px-6 py-2 bg-orange-500 text-white rounded-lg hover:bg-orange-600 transition-colors mt-auto">
                MANAGE REQUESTS
            </button>
        </div>
