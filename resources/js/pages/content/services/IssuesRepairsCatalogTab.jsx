...
export function IssuesRepairsCatalogTab({
    categories,
    setCategories,
    onSave,
    saveStatus,
        ...
        <div className="space-y-6">
            <div className="flex flex-wrap items-center justify-between gap-3">
                <p className="text-sm text-gray-500 dark:text-gray-400">
                    Kategorie a typy oprav —{' '}
                    <code className="text-xs">hotel_maintenance_categories</code>,{' '}
                    <code className="text-xs">hotel_maintenance_items</code>
                </p>
                    ...
                    <div className="space-y-3 pl-0 md:pl-4 border-l-0 md:border-l-2 border-orange-200 dark:border-orange-800">
                        {category.items.map((item, itemIndex) => (
                            ...
                            >
                                ...
                                <label className="md:col-span-2 block text-sm">
                                    <span className="text-gray-500 text-xs">Ikony</span>
                                    <select
                                        className={inputClass}
                                        value={item.icon_library}
                                        onChange={(e) =>
                                            updateItem(catIndex, itemIndex, {
                                                icon_library: e.target.value,
                                            })
                                        }
                                    >
                                ...
                                <label className="md:col-span-2 block text-sm">
                                    <span className="text-gray-500 text-xs">Název ikony</span>
                                    <input
                                        className={inputClass}
