...
export function HotelRooms() {
    ...
    const reloadSections = () =>
        axios.get('/api/hotel-rooms/types').then((response) => {
        ...
        reloadSections()
            .catch((err) => {
                const message =
                    ...
                    'Nepodařilo se načíst nabídku pokojů. Zkontroluj Supabase (OTELAPPS_DB_CONNECTION) a tabulky hotel_room_types.';
                setError(message);
            })
    ...
    if (loading) {
        return (
            <div className="p-6 flex items-center justify-center min-h-[40vh]">
                <p className="text-gray-600 dark:text-gray-400">Načítání nabídky pokojů…</p>
            </div>
        );
    }
