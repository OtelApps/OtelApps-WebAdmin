    ...
    return (
        <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {/* Hotel Overview Card */}
                <div className="bg-white dark:bg-gray-700 rounded-lg shadow-md p-6 flex flex-col h-full">
                ...
                {/* Add Content Card */}
                <div className="bg-white dark:bg-gray-700 rounded-lg shadow-md p-6 flex flex-col items-center text-center h-full">
