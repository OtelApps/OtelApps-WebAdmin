...
import { CheckoutQuestionsSection } from './CheckoutQuestionsSection';
import { CheckoutConfigurationSection } from './CheckoutConfigurationSection';
import { CheckoutFollowUpSection } from './CheckoutFollowUpSection';
...
export function CheckoutSurvey() {
    ...
    const [subtitle, setSubtitle] = useState('We hope you enjoyed your stay with us. Please, help us im...');
    
    const [questions, setQuestions] = useState([
        { id: 1, text: 'How was your stay?', category: 'Overall assessment' },
        { id: 2, text: 'How was the checkout process?', category: 'Checkout' },
        { id: 3, text: "How would you rate the staff\'s attention?", category: 'Staff' },
        { id: 4, text: 'How would you rate the value for money of our services?', category: 'Value for money' },
        { id: 5, text: 'Would you recommend our services to your friends or family?', category: 'Recommendation' },
    ]);
    ...
    return (
        <div className="p-6">
            ...
            <div className="flex items-center justify-between mb-8">
                <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Checkout survey</h1>
