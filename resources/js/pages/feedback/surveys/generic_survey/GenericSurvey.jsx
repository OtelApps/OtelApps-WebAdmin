...
import { GenericQuestionsSection } from './GenericQuestionsSection';
import { GenericConfigurationSection } from './GenericConfigurationSection';
import { GenericFollowUpSection } from './GenericFollowUpSection';

export function GenericSurvey() {
    const [activeTab, setActiveTab] = useState('questions');
    const [isActive, setIsActive] = useState(true); // From image it's 'Activated'
    
    const [title, setTitle] = useState('Your opinion matters!');
    const [subtitle, setSubtitle] = useState('Your opinion is important to us!');
    
    const [questions, setQuestions] = useState([
        { id: 1, text: 'How is your stay going so far?', category: 'Overall assessment' },
        { id: 2, text: 'How would you rate the quality of service?', category: 'Service' },
    ...
    const [promptSignInRequired, setPromptSignInRequired] = useState('Optional');
    ...
    return (
        <div className="p-6">
            ...
            <div className="flex items-center justify-between mb-8">
                <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Generic survey</h1>
