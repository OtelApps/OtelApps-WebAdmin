...
export function FacilitiesServicesQuestionsSection({
    title, setTitle,
    ...
    const addQuestion = () => {
        ...
        setQuestions([
            ...questions,
            { id: newId, text: '', category: CATEGORIES[0] }
        ]);
    };
    ...
    return (
        <div className="space-y-6">
                        ...
                        {questions.map((q) => (
                            <div key={q.id} className="flex gap-4 items-start">
                                <div className="flex-1 flex rounded-lg border border-gray-200 dark:border-gray-600 overflow-hidden focus-within:ring-2 focus-within:ring-purple-500 focus-within:border-purple-500">
                                    <div className="flex items-center justify-center px-4 bg-gray-50 dark:bg-gray-900 border-r border-gray-200 dark:border-gray-600 cursor-move hover:bg-gray-100 transition-colors">
                                        <span className="material-symbols-outlined text-gray-400 text-[20px]">flag</span>
                                    </div>
                                    <input
                                        type="text"
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-8">
                ...
                <div className="space-y-4">
                    {thankYouMessages && thankYouMessages.map(msg => (
