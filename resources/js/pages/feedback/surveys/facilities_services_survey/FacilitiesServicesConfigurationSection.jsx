...
export function FacilitiesServicesConfigurationSection({
    ...
    proactiveModeActive, setProactiveModeActive
}) {
    return (
        <div className="space-y-6">
                            ...
                            <div className="flex items-center justify-between gap-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className={`text-sm font-medium ${showAfterActive ? 'text-gray-700 dark:text-gray-200' : 'text-gray-400 dark:text-gray-500'}`}>
                                        Show right after the reservation time
                                    </span>
                                </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-8">
                <div className="mb-6">
                    <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Proactive mode</h2>
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                        This option keeps the survey banner always visible on the service screen.
                    </p>
                </div>
                
                <div className="flex items-center gap-3">
                    <button 
                        onClick={() => setProactiveModeActive(!proactiveModeActive)}
                        className={`relative inline-flex h-6 w-11 shrink-0 items-center rounded-full transition-colors ${proactiveModeActive ? 'bg-teal-400' : 'bg-gray-200 dark:bg-gray-700'}`}
                    >
                        <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${proactiveModeActive ? 'translate-x-6' : 'translate-x-1'}`} />
                    </button>
                    <span className="font-bold text-gray-700 dark:text-gray-200">
                        Activated
                    </span>
