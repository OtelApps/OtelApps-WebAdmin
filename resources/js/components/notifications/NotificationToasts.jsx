    ...
    return (
        <div className="pointer-events-none fixed bottom-6 right-6 z-[10002] flex max-w-sm flex-col gap-3">
            {toasts.map((toast) => (
                <div
                    key={toast.toastId}
                    className="pointer-events-auto overflow-hidden rounded-xl border border-gray-200 bg-white shadow-xl dark:border-gray-600 dark:bg-gray-800"
                >
                    ...
                    <div className="flex gap-3 p-4">
                        <span className="material-symbols-outlined text-2xl text-orange-500">
                            {toast.source === 'concierge' ? 'chat' : 'moving'}
                        </span>
