...
use App\Http\Controllers\Api\HotelConfigController;
...
use App\Http\Controllers\Api\PlatformHotelController;
...
Route::prefix('api')->group(function () {
    ...
    Route::get('/public/hotel/{slug}/config', [HotelConfigController::class, 'publicConfig']);
    ...
    Route::prefix('platform')->group(function () {
        ...
        Route::middleware(['auth:sanctum', 'superadmin'])->group(function () {
            ...
            Route::get('/module-catalog', [PlatformHotelController::class, 'catalog']);
            Route::get('/hotels', [PlatformHotelController::class, 'index']);
            Route::post('/hotels', [PlatformHotelController::class, 'store']);
            Route::get('/hotels/{slug}', [PlatformHotelController::class, 'show']);
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::get('/hotel/modules', [HotelConfigController::class, 'modules']);
        Route::put('/hotel/modules', [HotelConfigController::class, 'updateModules']);
